...
public class Tecnico_di_Laboratorio {



	private String Matricola_TDL;
	private String Nome;
...
public Tecnico_di_Laboratorio() {
	
}
public Tecnico_di_Laboratorio(String nome, String cognome) {
	super();
	Nome = nome;
	Cognome = cognome;
}
...
public String getMatricola_TDL() {
	return Matricola_TDL;
}


public void setMatricola_TDL(String matricola_TDL) {
	Matricola_TDL = matricola_TDL;
}
