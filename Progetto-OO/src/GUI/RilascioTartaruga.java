...
public class RilascioTartaruga extends JDialog {
	 ...
	 * Create the panel.
	 */
	public RilascioTartaruga(Controllore contr) {
		controller=contr;
		...
		lblNewLabel.setIcon(new ImageIcon(RilascioTartaruga.class.getResource("/Media/wave_lines_100px.png")));
		lblNewLabel.setBounds(10, 10, 139, 96);
		panel.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("RILASCIO TARTARUGA");
		lblNewLabel_1.setForeground(new Color(255, 255, 255));
		lblNewLabel_1.setFont(new Font("SansSerif", Font.BOLD, 18));
		lblNewLabel_1.setBounds(126, 10, 224, 40);
		panel.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("Inserire i dati per il rilascio della tartaruga");
		...
		JLabel lblNewLabel_4 = new JLabel("Data Rilascio : ");
		...
		Inserisci.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
                ...
                boolean flag=controller.RilasciaTurtle(id_turtle, date);
                if(flag)
                {
	...
	public void alertUpdateNonRiuscito(String id) {
		JOptionPane.showMessageDialog(this, "Rilascio della tartaruga : "+id+"  non riuscito!","<ATTENZIONE>", JOptionPane.INFORMATION_MESSAGE);
	}
	public void alertUpdateRiuscito(String id) {
		JOptionPane.showMessageDialog(this, "Rilascio della tartaruga : "+id+"  riuscito!","<ATTENZIONE>", JOptionPane.INFORMATION_MESSAGE);
	}
}
