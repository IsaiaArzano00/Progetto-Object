...
public class InserimentoCartellaMedicapt1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InserimentoCartellaMedicapt1 frame = new InserimentoCartellaMedicapt1();
	 ...
	 * Create the frame.
	 */
	public InserimentoCartellaMedicapt1() {
