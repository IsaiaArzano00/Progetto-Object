...
public class InsertLaboratorioPanel extends JPanel {
	private JTextField numero_lab;
	private Controllore controller;
	/**
	 * Create the panel.
	 */
	public InsertLaboratorioPanel() {
		...
		lblNewLabel.setIcon(new ImageIcon(InsertLaboratorioPanel.class.getResource("/Media/Lab Items_100px.png")));
