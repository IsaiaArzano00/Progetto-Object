...
public class PannelloDonazioni extends JPanel {
    ...
    public PannelloDonazioni(Controllore contr) {
        ...
        panel_aggiungi.setLayout((LayoutManager)null);
        ...
        panel_lista.setLayout((LayoutManager)null);
        ...
        panel_rimuovi.setLayout((LayoutManager)null);
        ...
        panel_modifica.setLayout((LayoutManager)null);
        ...
        tasto_AggiungiDonazione.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                PannelloDonazioni.this.controller.InserimentoDonazionePage();
            }
        });
        tasto_RimuoviDonazione.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                PannelloDonazioni.this.controller.RimozioneDonazionePage();
            }
        });
        tasto_ListaDonazioni.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                PannelloDonazioni.this.controller.ListaDonazioniPage();
            }
        });
        tasto_ModificaDonazione.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                PannelloDonazioni.this.controller.ModificaDonazioniPage();
            }
        });
    }
}
