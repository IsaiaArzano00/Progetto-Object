...
public class PanelPreCancellaCartella extends JPanel {
	private Controllore controller;

	/**
	 * Create the panel.
	 */
	public PanelPreCancellaCartella(Controllore contr,JPanel sfondo_dash) {
controller = contr;
        ...
        JLabel lblNewLabel = new JLabel("CANCELLA  CARTELLA  MEDICA ");
        ...
        txtInfo.setText("Selezionare dalla tabella sottostante la tartaruga a cui bisogna cancellare la cartella medica.");
        ...
        GoBack.setIcon(new ImageIcon(PanelPreCancellaCartella.class.getResource("/Media/undo_50px.png")));
        ...
        tbl.addMouseListener(new MouseAdapter(){
            public void mouseClicked(MouseEvent e){
            	...
            	EliminaCartellaMedica info = new EliminaCartellaMedica(controller,turtle_id);
